...
/** UTF-8 encode without TextEncoder, which is not part of the core's platform contract. */
...
/**
 * Synchronous SHA-256. The Web Crypto digest is async, which would force the whole token
 * verification path to become asynchronous, so the core carries its own implementation.
 */
